...
import ydk.ui.pickview.listener.LoopViewGestureListener;
import ydk.ui.pickview.listener.OnItemSelectedListener;
import ydk.ui.pickview.timer.InertiaTimerTask;
import ydk.ui.pickview.timer.MessageHandler;
import ydk.ui.pickview.timer.SmoothScrollTimerTask;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.yui_pickerview, 0, 0);
            mGravity = a.getInt(R.styleable.yui_pickerview_yui_wheelview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.yui_pickerview_yui_wheelview_textColorOut, 0xFFa8a8a8);
            textColorCenter = a.getColor(R.styleable.yui_pickerview_yui_wheelview_textColorCenter, 0xFF2a2a2a);
            dividerColor = a.getColor(R.styleable.yui_pickerview_yui_wheelview_dividerColor, 0xFFd5d5d5);
            textSize = a.getDimensionPixelOffset(R.styleable.yui_pickerview_yui_wheelview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.yui_pickerview_yui_wheelview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
...
//                canvas.scale(1.0F, (float) Math.sin(radian));
    ...
    public void setItemsVisible(int itemsVisible) {
        if (itemsVisible <= 3) {
            this.itemsVisible = 5;
        } else if (itemsVisible >= 9) {
            this.itemsVisible = 11;
        } else {
            this.itemsVisible = this.itemsVisible + 2;
        }
    }
}