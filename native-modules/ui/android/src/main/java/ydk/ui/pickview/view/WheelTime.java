...
import ydk.ui.R;
import ydk.ui.pickview.adapter.ArrayWheelAdapter;
import ydk.ui.pickview.adapter.NumericWheelAdapter;
import ydk.ui.pickview.listener.ISelectTimeCallback;
import ydk.ui.pickview.listener.OnItemSelectedListener;
import ydk.ui.pickview.utils.ChinaDate;
import ydk.ui.pickview.utils.LunarCalendar;
...
//                maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_year != null) {
            ...
            wv_year.setLabel(view.getContext().getString(R.string.yui_pickerview_year));
        }
        if (label_month != null) {
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string.yui_pickerview_month));
        }
        if (label_day != null) {
            wv_day.setLabel(label_day);
        } else {
            wv_day.setLabel(view.getContext().getString(R.string.yui_pickerview_day));
        }
        if (label_hours != null) {
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string.yui_pickerview_hours));
        }
        if (label_mins != null) {
            wv_minutes.setLabel(label_mins);
        } else {
            wv_minutes.setLabel(view.getContext().getString(R.string.yui_pickerview_minutes));
        }
        if (label_seconds != null) {
            wv_seconds.setLabel(label_seconds);
        } else {
            wv_seconds.setLabel(view.getContext().getString(R.string.yui_pickerview_seconds));
        }
    ...
    public void setItemsVisibleCount(int itemsVisibleCount){
        wv_year.setItemsVisible(itemsVisibleCount);
        wv_month.setItemsVisible(itemsVisibleCount);
        wv_day.setItemsVisible(itemsVisibleCount);
        wv_hours.setItemsVisible(itemsVisibleCount);
        wv_minutes.setItemsVisible(itemsVisibleCount);
        wv_seconds.setItemsVisible(itemsVisibleCount);
    }
