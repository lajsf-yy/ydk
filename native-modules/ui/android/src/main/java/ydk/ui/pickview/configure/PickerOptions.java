package ydk.ui.pickview.configure;
...
public class PickerOptions {
    ...
    public View.OnClickListener cancelListener, titleClickListener;
    ...
    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.yui_pickerview_options;
        } else {
            layoutRes = R.layout.yui_pickerview_time;
        }
    }
