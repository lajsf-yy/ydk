...
package ydk.qrcode.zixing.view;
...
public final class ViewfinderView extends View {
    ...
    public void setZxingConfig(ZxingConfig config) {
        ...
        if (config.getFrameLineColor() != -1) {
            frameLineColor = config.getFrameLineColor();
        }

        scanLineColor = config.getScanLineColor();
        initPaint();
    ...
    private void initPaint() {
        ...
        if (frameLineColor != -1) {
            ...
            frameLinePaint.setColor(config.getFrameLineColor());
