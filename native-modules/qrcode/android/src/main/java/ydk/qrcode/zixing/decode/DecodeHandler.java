...
public final class DecodeHandler extends Handler {
    ...
    DecodeHandler(ICaptureHandler iCaptureHandler, Map<DecodeHintType, Object> hints) {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        PlanarYUVLuminanceSource source = iCaptureHandler.getCameraManager()
        ...
        Handler handler = iCaptureHandler.getHandler();
        if (rawResult != null) {
