...
public class RxPermissions {
     ...
     */
    @SuppressWarnings("WeakerAccess")
    public <T> ObservableTransformer<T, List<Permission>> ensureEach(final String... permissions) {
        return new ObservableTransformer<T, List<Permission>>() {
            @Override
            public ObservableSource<List<Permission>> apply(Observable<T> o) {
     ...
     */
    @SuppressWarnings({"WeakerAccess", "unused"})
    public Observable<List<Permission>> requestEach(final String... permissions) {
