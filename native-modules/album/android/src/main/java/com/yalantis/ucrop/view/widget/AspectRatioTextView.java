...
public class AspectRatioTextView extends TextView {
    ...
    public AspectRatioTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.yui_ucrop_AspectRatioTextView);
        init(a);
    }
    ...
    private void init(@NonNull TypedArray a) {
        ...
        mAspectRatioTitle = a.getString(R.styleable.yui_ucrop_AspectRatioTextView_yui_ucrop_artv_ratio_title);
        mAspectRatioX = a.getFloat(R.styleable.yui_ucrop_AspectRatioTextView_yui_ucrop_artv_ratio_x, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
        mAspectRatioY = a.getFloat(R.styleable.yui_ucrop_AspectRatioTextView_yui_ucrop_artv_ratio_y, CropImageView.SOURCE_IMAGE_ASPECT_RATIO);
