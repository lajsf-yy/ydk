...
public class UCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yui_ucrop_activity_photobox);
...
//        getMenuInflater().inflate(R.menu.yui_ucrop_menu_activity, menu);
//
...
//                Log.i(TAG, String.format("%s - %s", e.getMessage(), getString(R.string.yui_ucrop_mutate_exception_hint)));
//            }
...
//    }
    ...
    private void setImageData(@NonNull Intent intent) {
        ...
        if (inputUri != null && outputUri != null) {
            ...
            setResultError(new NullPointerException(getString(R.string.yui_ucrop_error_input_data_is_absent)));
            closeActivity();
        }
    }
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        mToolbarTitle = mToolbarTitle != null ? mToolbarTitle : getResources().getString(R.string.yui_ucrop_label_edit_photo);
        ...
        if (mShowBottomControls) {
            ...
            View.inflate(this, R.layout.yui_ucrop_controls, photoBox);
    ...
    private void setupAppBar() {
        ...
        findViewById(R.id.header).setBackgroundColor(mToolbarColor);

        findViewById(R.id.title_close).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onBackPressed();
            }
        });
        findViewById(R.id.title_confirm).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cropAndSaveImage();
            }
...
//        findViewById(R.id.ucrop_frame).setBackgroundColor(mRootViewBackgroundColor);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        if (aspectRatioList == null || aspectRatioList.isEmpty()) {
            ...
            aspectRatioList.add(new AspectRatio(getString(R.string.yui_ucrop_label_original).toUpperCase(),
        ...
        for (AspectRatio aspectRatio : aspectRatioList) {
            wrapperAspectRatio = (FrameLayout) getLayoutInflater().inflate(R.layout.yui_ucrop_aspect_ratio, null);
    ...
    protected void closeActivity() {
        finish();
        overridePendingTransition(0, R.anim.yui_ucrop_close);
    }
}
