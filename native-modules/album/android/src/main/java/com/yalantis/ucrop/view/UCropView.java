...
public class UCropView extends FrameLayout {
    ...
    public UCropView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(R.layout.yui_ucrop_view, this, true);
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.yui_ucrop_UCropView);
