 ...
 */
package com.luck.picture.transcoder;
...
import com.luck.picture.transcoder.engine.MediaTranscoderEngine;
import com.luck.picture.transcoder.format.MediaFormatPresets;
import com.luck.picture.transcoder.format.MediaFormatStrategy;
...
public class MediaTranscoder {
     ...
     * @deprecated Use {@link #transcodeVideo(FileDescriptor, String, MediaFormatStrategy, Listener)} which accepts output video format.
     */
    @Deprecated
    ...
    public Future<Void> transcodeVideo(final String inPath, final String outPath, final MediaFormatStrategy outFormatStrategy, final Listener listener) throws IOException {
        ...
        return transcodeVideo(inFileDescriptor, outPath, outFormatStrategy, new Listener() {
            ...
            public boolean isTranscodeCanceled() {
                return listener.isTranscodeCanceled();
            }
