...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.yui_picture_activity_external_preview);
    ...
    public class SimpleFragmentAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View contentView = inflater.inflate(R.layout.yui_picture_image_preview, container, false);
            // 常规图控件
    ...
    private void showDownLoadDialog(final String path) {
        final CustomDialog dialog = new CustomDialog(PictureExternalPreviewActivity.this,
                ...
                R.layout.yui_picture_wind_base_dialog_xml, R.style.yui_Theme_dialog);
        Button btn_cancel = (Button) dialog.findViewById(R.id.btn_cancel);
        Button btn_commit = (Button) dialog.findViewById(R.id.btn_commit);
        TextView tv_title = (TextView) dialog.findViewById(R.id.tv_title);
        TextView tv_content = (TextView) dialog.findViewById(R.id.tv_content);
        tv_title.setText(getString(R.string.yui_picture_prompt));
        tv_content.setText(getString(R.string.yui_picture_prompt_content));
            ...
            public void onClick(View view) {
                ...
                if (isHttp) {
                    ...
                    try {
                        ...
                        ToastManage.s(mContext, getString(R.string.yui_picture_save_success) + "\n" + dirPath);
                        dismissDialog();
                    } catch (IOException e) {
                        ToastManage.s(mContext, getString(R.string.yui_picture_save_error) + "\n" + e.getMessage());
                        dismissDialog();
                        e.printStackTrace();
                    }
                }
