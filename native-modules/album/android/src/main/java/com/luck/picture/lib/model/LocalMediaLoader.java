                    ...
                    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
                        ...
                        switch (id) {
                            ...
                            case PictureConfig.TYPE_VIDEO:
                                ...
                                cursorLoader = new CursorLoader(
                                        activity, QUERY_URI, PROJECTION, video_condition
//                                        + " AND " + MediaStore.MediaColumns.SIZE + "<250000000"//less than 250M
                                        + " AND " + MediaStore.MediaColumns.MIME_TYPE + "='video/mp4'",
                                        MEDIA_TYPE_VIDEO
                                        , ORDER_BY);
                                break;
                                ...
                                if (count > 0) {
                                    ...
                                    if (latelyImages.size() > 0) {
                                        ...
                                        String title = type == PictureMimeType.ofAudio() ?
                                                activity.getString(R.string.yui_picture_all_audio)
                                                : activity.getString(R.string.yui_picture_camera_roll);
