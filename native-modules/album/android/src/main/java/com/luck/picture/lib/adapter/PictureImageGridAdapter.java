...
//        this.showCamera = config.mimeType == PictureConfig.TYPE_IMAGE;//config.isCamera;
        this.showCamera = config.isCamera;//是否显示拍摄入口
        ...
        animation = OptAnimationLoader.loadAnimation(context, R.anim.yui_modal_in);
    }
...
//        this.showCamera = showCamera;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == PictureConfig.TYPE_CAMERA) {
            View view = LayoutInflater.from(context).inflate(R.layout.yui_picture_item_camera, parent, false);
            return new HeaderViewHolder(view);
        } else {
            View view = LayoutInflater.from(context).inflate(R.layout.yui_picture_image_grid_item, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == PictureConfig.TYPE_CAMERA) {
            ...
            if (mimeType == PictureMimeType.ofAudio()) {
                contentHolder.iv_picture.setImageResource(R.drawable.yui_audio_placeholder);
            } else {
                ...
                options.centerCrop();
                options.placeholder(R.drawable.yui_image_placeholder);
                Glide.with(context)
                        .asBitmap()
                        .load(path)
                        .apply(options)
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            ...
            String title = mimeType == PictureMimeType.ofAudio() ?
                    context.getString(R.string.yui_picture_tape)
                    : context.getString(R.string.yui_picture_take_picture);
    ...
    private void changeCheckboxState(ViewHolder contentHolder, LocalMedia image) {
        ...
        if (!TextUtils.isEmpty(pictureType)) {
            ...
            if (!toEqual) {
                ToastManage.s(context, context.getString(R.string.yui_picture_rule));
                return;
            }
        }
        if (selectImages.size() >= maxSelectNum && !isChecked) {
            boolean eqImg = pictureType.startsWith(PictureConfig.IMAGE);
            String str = eqImg ? context.getString(R.string.yui_picture_message_max_num, maxSelectNum)
                    : context.getString(R.string.yui_picture_message_video_max_num, maxSelectNum);
        ...
        if (isChecked) {
            ...
            if (selectMode == PictureConfig.SINGLE
                    || PictureMimeType.isPictureType(pictureType) == PictureConfig.TYPE_VIDEO) {
